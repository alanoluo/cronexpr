...
var (
	...
	dowTokens = map[string]int{
		`00`: 0, `0`: 0, `sun`: 0, `sunday`: 0,
		`01`: 1, `1`: 1, `mon`: 1, `monday`: 1,
		`02`: 2, `2`: 2, `tue`: 2, `tuesday`: 2,
		`03`: 3, `3`: 3, `wed`: 3, `wednesday`: 3,
		`04`: 4, `4`: 4, `thu`: 4, `thursday`: 4,
		`05`: 5, `5`: 5, `fri`: 5, `friday`: 5,
		`06`: 6, `6`: 6, `sat`: 6, `saturday`: 6,
		`07`: 0, `7`: 0,
	}
)
